...
function stringToNumber(str) {
  const num=Number(str);// Використовуємо Number() для перетворення рядка в число
  return num;// Повертаємо отримане число
}
...
function isAlmostSame(num1, num2) {
  const num3 = num1 - num2; const num4 = num2 - num1;
  return num3<=Number.EPSILONnum || num4<=Number.EPSILON;// Визначаємо, чи є різниця між двома числами меншою або рівною EPSILON
}
